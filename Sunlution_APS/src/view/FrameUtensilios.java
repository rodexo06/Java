...
public class FrameUtensilios extends JFrame {
	...
	public FrameUtensilios() {
		 ...
		 * ImageIcon(this.getClass().getResource("/icon_house.png")).getImage();
		...
		// LAMPADA
		JLabel lblLampada = new JLabel("L̢mpada");
