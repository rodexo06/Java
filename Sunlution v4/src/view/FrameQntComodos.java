...
public class FrameQntComodos extends JFrame {
	...
	public FrameQntComodos() {
		...
		JLabel lblreaDeServio = new JLabel("Area de Serviço");
		...
		/*Image imgLogoMin = new ImageIcon(this.getClass().getResource("/logo_min.png")).getImage();
		...
		/*Image imgIconQuarto = new ImageIcon(this.getClass().getResource("/icon_quarto.png")).getImage();
		...
		/*Image imgIconSala = new ImageIcon(this.getClass().getResource("/icon_sala.png")).getImage();
		...
		/*Image imgIconCozinha = new ImageIcon(this.getClass().getResource("/icon_cozinha.png")).getImage();
		...
		/*Image imgIconBanheiro = new ImageIcon(this.getClass().getResource("/icon_banheiro.png")).getImage();
		...
		/*Image imgIconArea = new ImageIcon(this.getClass().getResource("/icon_Area.png")).getImage();
		...
		/*Image imgNext = new ImageIcon(this.getClass().getResource("/icon_done.png")).getImage();
