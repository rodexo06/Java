...
public class FrameHome extends JFrame {
	...
	public static StringBuffer relconsumo = new StringBuffer();
	public static StringBuffer relsolar = new StringBuffer();
	...
	*/
	...
	public FrameHome() {
		...
		//Image imgLogo = new ImageIcon(this.getClass().getResource(".../img/home.png")).getImage();
		...
		JLabel lblPorFavorSelecione = new JLabel("Vamos começar!");
		...
		//Image imgNext = new ImageIcon(this.getClass().getResource("img/icon_next.png")).getImage();
	...
	public static Residencia getResidencia() {
		return residencia;
	}

	public static void setResidencia(Residencia residencia) {
		FrameHome.residencia = residencia;
	}
}
